            ...
            switch (objToMove.ObjectClass)
            {
                ...
                case GameObjectClass.StaticObject:
                    ...
                    newGeomInfo = BBXItemParser<CookerType>.getGeomInfo(
                        attributes, new float[3] { x, y, z }, oldGeomInfo.Mass, oldGeomInfo.Friction, oldGeomInfo.RollingFriction, oldGeomInfo.Restitution, oldGeomInfo.AngularDamping, oldGeomInfo.Model);
